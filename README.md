# class-transform-decorators

Note: This is a fork of the wonderful package https://www.npmjs.com/package/class-transformer

tl;dr on the fork? The original package seems a bit stale and it is missing some functionality that I felt was important.
I have cherry picked from other forks and may continue to do so based on my needs. While this package is published globally
for all to use, I would not recommend it and do not make any promises around support. Use at your own risk - the MIT license
remains preserved.
...
- [class-transform-decorators](#class-transform-decorators)
